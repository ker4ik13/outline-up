...
export interface ApiAccordionsAccordions extends Schema.CollectionType {
  ...
  info: {
    singularName: 'accordions';
    pluralName: 'accordions-api';
...
export interface ApiMetaTagsMetaTags extends Schema.CollectionType {
  collectionName: 'meta_tags_api';
  info: {
    singularName: 'meta-tags';
    pluralName: 'meta-tags-api';
...
export interface ApiRatesRates extends Schema.CollectionType {
  collectionName: 'rates_api';
  info: {
    singularName: 'rates';
    pluralName: 'rates-api';
    displayName: '\u0422\u0430\u0440\u0438\u0444\u044B';
    description: '';
  };
  options: {
  ...
  attributes: {
    ...
    advantages: Attribute.Text & Attribute.Required;
    price: Attribute.Integer & Attribute.Required;
    mostProfitable: Attribute.Boolean & Attribute.DefaultTo<false>;
